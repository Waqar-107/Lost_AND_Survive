...
public class PoliceMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng destLatLng = new LatLng(Utils.desLatitude,Utils.desLongitude);

        mMap.addMarker(new MarkerOptions().position(destLatLng).title("Police Station"));

        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(currentPlace,18));




        String url = getDirectionsUrl(currentPlace,destLatLng);
